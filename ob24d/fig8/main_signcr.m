...
ALPHA_LIST = [2*pi,2*pi,2*pi,2*pi,2*pi,2*pi,2*pi];
N_LIST = [100,100,100,100,100,100,100]; %[10,20,50,100,200,500,1000]; %[100,100,100,100,100,100,100];
MU_LIST = [10,30,50,100,300,500,1000]; [100,100,100,100,100,100,100];
VAR_LIST = MU_LIST;
NUM_VAR = length(MU_LIST);
SHOW_PLOT = 0;
...
% MU_LIST = [100,100,100,100,100,100,100];
% VAR_LIST = N_LIST;
% NUM_VAR = length(N_LIST);
% SHOW_PLOT = 0;


%% CONFIG 3 (When plot is done, switch to linear x-y-scales)
% A_LIST = [0.5,1,2,4,6,8,10];
% ALPHA_LIST = [2*pi,2*pi,2*pi,2*pi,2*pi,2*pi,2*pi];
% N_LIST = [100,100,100,100,100,100,100];
% MU_LIST = [100,100,100,100,100,100,100];
% VAR_LIST = A_LIST;
