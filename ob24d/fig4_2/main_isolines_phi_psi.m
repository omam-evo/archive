...
SIGMA_NORM_LIST = linspace(20, ceil(1.1*x_2ndZero), NUM_VAL); %1.2*x_2ndZero
...
xlim([SIGMA_NORM_LIST(1),SIGMA_NORM_LIST(end)]);
ylim([0,R_LIST(end)]);
set(gca, 'YScale', 'log');
...
plot([0,SIGMA_NORM_LIST(end)],[R_inf,R_inf], 'w--');
