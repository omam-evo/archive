...
%% Phi 1
COMP_ID = 2; getpath = '';
[~, phi_1_A3, phi_1_C_f] = ep.get_phi1_i_plot(ras_tools, MU, LAM, A, ALPHA, SIGMA_LIST, Y_MAT, ...
    phi_1_mean, phi_1_stderr, FLAG_SIGMA_NORM, COMP_ID, getpath, {'SIM','A3'}); %'ki', 'di'
myfigstyle(gcf, 9, 5, 9, 9);

COMP_ID = 2; getpath = '';
[~, phi_1_A3, phi_1_C_f] = ep.get_phi1_i_plot(ras_tools, MU, LAM, A, ALPHA, SIGMA_LIST, Y_MAT, ...
    phi_1_mean, phi_1_stderr, FLAG_SIGMA_NORM, COMP_ID, getpath, {'SIM','A3','ki'}); %'ki', 'di'
myfigstyle(gcf, 9, 5, 9, 9);

COMP_ID = 2; getpath = '';
[~, phi_1_A3, phi_1_C_f] = ep.get_phi1_i_plot(ras_tools, MU, LAM, A, ALPHA, SIGMA_LIST, Y_MAT, ...
    phi_1_mean, phi_1_stderr, FLAG_SIGMA_NORM, COMP_ID, getpath, {'SIM','A3','di'}); %'ki', 'di'
myfigstyle(gcf, 9, 5, 9, 9);
