function [r_g,sigma_g,sigma_norm_g] = get_medians(r_g_t, sigma_g_t, flag_success, vec_select, N, OPTIONS)
    ...
    if any(strcmpi(OPTIONS, 'dyn'))
        figure;  hold on;
            ...
            xlabel('Generation $g$'); ylabel('Dynamics');
            set(gca, 'YScale', 'log');
