function [y_n_rec, F_opt_vec, delta_r_vec, sigma_vec, gen] = muComLam_sSA(fit, N_DIM, MU, LAM, Y_0, Y_HAT, SIGMA_0, TAU, SIGMA_STOP, F_STOP, N_G, verbose)
...
%       end
        ...
        %%   Vectorized
        s_lam = repmat(s_rec * exp(TAU * randn(1, LAM)), N_DIM, 1); % sigma indep. of dim
        y_n_lam = repmat(y_n_rec, 1, LAM) + s_lam.*randn(N_DIM, LAM);
        F_lam = fit(y_n_lam);
