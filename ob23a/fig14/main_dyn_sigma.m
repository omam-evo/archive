...
N = 100;
A = 10;
SIGMA_LIST = [0.1,0.2,0.3,0.4,0.436,0.5,0.6]; %[0.1,0.2,0.3,0.4,0.436,0.5];
N_G = 10000;
SEED = 1;
...
%% Main Loop 
flag_success = zeros(length(SIGMA_LIST), TRIALS);
tic
...
for s=1:length(SIGMA_LIST)
    ...
    for i = 1:TRIALS
            ...
            [y_opt, F_opt_g, r_g, sigma_g, gen, y_g] = muComLam_sigma_maxInfo(FIT, N, MU, LAM, Y_0, Y_HAT, SIGMA_G, SIGMA_STOP, R_STOP, N_G, 1);
