clear
load('data.mat'); %data also contained in data_wsp.txt
...
get_scaling_sim(VAR, MU_givenP, P_target, 'firstCall');
% get lines
get_scaling_lines(VAR, 4);
% plot again for better visibility
get_scaling_sim(VAR, MU_givenP, P_target, 'secondCall');
