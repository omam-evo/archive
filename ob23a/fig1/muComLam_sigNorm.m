function [y_n_rec, F_opt_vec, delta_r_vec, sigma_vec, gen] = muComLam_sigNorm(fit, N, MU, LAM, Y_0, Y_HAT, SIGMA_NORM, SIGMA_STOP, R_STOP, N_G, verbose)
    ...
    for g = 1:N_G+1
        ...
        s_rec = SIGMA_NORM * r / N; %s_rec = mean(s_mu, 2);
