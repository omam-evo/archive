...
N_LIST = [30,50,70,100,170,300];
MU_RANGE = [400,500; 650,750; 800,1000; 1000,1300; 1400,1700; 2100,2500];
RANGE_MODE = 'LIN';
NUM_MU = 5;
TRIAL_LIST = repmat([3000,3000,1500,1000,700,600], NUM_MU,1);
rng('shuffle');
...
%% R init
a = 100;  % A=10 requires at least a=31
