...
%% LARGE DOE
LAM_LIST = [100:100:1000];
TAU_LIST = [0.02:0.01:0.08];
THETA_LIST = [0.1:0.1:0.6];

% sqrt(1/N.*(1-8./(ALPHA.^2.*A).*lambertw(0, ALPHA.^3.*A.^(3/2)/8)))
    ...
    for m=1:N_lam
        ...
        for i = 1:TRIALS
            ...
            if f_g(gen) < F_STOP
                ...
                dat_suc(n,t,v,m,i) = 0;
                dat_f_delta(n,t,v,m,i) = log10(f_g(gen+1)/F_STOP);
            end
            g0 = round(gen/5);
